            ...
            try
            {
                ...
                OracleHelper.ExecuteNonQuery(ConfigData.gConnectionString,
                    CommandType.StoredProcedure, "pkg_msg_tprl_hnx_confirm.proc_insert",
                     ...
                     new OracleParameter("p_symbol", OracleDbType.Decimal, objData.Symbol, ParameterDirection.Input),
                     ...
                     new OracleParameter("p_settlvalue", OracleDbType.Varchar2, objData.Settlvalue, ParameterDirection.Input),
                     new OracleParameter("p_leavesqty", OracleDbType.Decimal, objData.Leavesqty, ParameterDirection.Input),
                     new OracleParameter("p_origclordid", OracleDbType.Decimal, objData.Origclordid, ParameterDirection.Input),
                     ...
                     new OracleParameter("p_execid", OracleDbType.Decimal, objData.Execid, ParameterDirection.Input),
