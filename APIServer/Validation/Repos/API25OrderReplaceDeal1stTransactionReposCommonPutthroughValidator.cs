...
{
    public class API25OrderReplaceDeal1stTransactionReposCommonPutthroughValidator : AbstractValidator<API25OrderReplaceDeal1stTransactionReposCommonPutthroughRequest>
    {
        public API25OrderReplaceDeal1stTransactionReposCommonPutthroughValidator()
        {
            ...
            {
                if (checkQuoteType != QuoteType_BCGDRepos.LENH_SUA_THOATHUAN_DA_THUC_HIEN_REPOS_TRONG_NGAY)
                {
                    return false;
                }
                return true;
            ...
            //
            RuleForEach(x => x.SymbolFirmInfo).SetValidator(new API25SymbolFirmInfoValidator());
        }

        public class API25SymbolFirmInfoValidator : AbstractValidator<APIReposSideList>
        {
            public API25SymbolFirmInfoValidator()
            {
                //
