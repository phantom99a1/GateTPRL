...
namespace APIServer.Validation
{
    ...
    /// </summary>
    public class API17OrderNewFirmReposValidator : AbstractValidator<API17OrderNewFirmReposRequest>
    {
        public API17OrderNewFirmReposValidator()
        {
            ...
            //
            RuleForEach(x => x.SymbolFirmInfo).SetValidator(new API17SymbolFirmInfoValidator());
        }

        public class API17SymbolFirmInfoValidator : AbstractValidator<APIReposSideList>
        {
            public API17SymbolFirmInfoValidator()
            {
                //
