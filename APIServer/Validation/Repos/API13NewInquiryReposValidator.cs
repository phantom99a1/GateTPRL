...
{
    public class API13NewInquiryReposValidator : AbstractValidator<API13NewInquiryReposRequest>
    {
        public API13NewInquiryReposValidator()
        {
            ...
            {
                if (checkQuoteType != QuoteType.LENH_DAT_INQUIRY)
                {
                    return false;
                }
                return true;
