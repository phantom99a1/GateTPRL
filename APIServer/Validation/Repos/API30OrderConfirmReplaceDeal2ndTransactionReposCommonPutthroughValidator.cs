...
namespace APIServer.Validation
{
    ...
    /// </summary>
    public class API30OrderConfirmReplaceDeal2ndTransactionReposCommonPutthroughValidator : AbstractValidator<API30OrderConfirmReplaceDeal2ndTransactionReposCommonPutthroughRequest>
    {
        public API30OrderConfirmReplaceDeal2ndTransactionReposCommonPutthroughValidator()
        {
            ...
            {
                if (checkQuoteType != QuoteType_BCGDRepos.CHAP_NHAN_SUA_THOATHUAN_DA_THUC_HIEN_REPOS && checkQuoteType != QuoteType_BCGDRepos.TU_CHOI_SUA_THOATHUAN_DA_THUC_HIEN_REPOS)
                {
                    return false;
                }
                return true;
            ...
            //
            RuleForEach(x => x.SymbolFirmInfo).SetValidator(new API30SymbolFirmInfoValidator());
        }

        public class API30SymbolFirmInfoValidator : AbstractValidator<APIReposSideList>
        {
            public API30SymbolFirmInfoValidator()
            {
                //
