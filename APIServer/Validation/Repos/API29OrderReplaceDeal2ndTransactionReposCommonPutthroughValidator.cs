...
namespace APIServer.Validation
{
    ...
    /// </summary>
    public class API29OrderReplaceDeal2ndTransactionReposCommonPutthroughValidator : AbstractValidator<API29OrderReplaceDeal2ndTransactionReposCommonPutthroughRequest>
    {
        public API29OrderReplaceDeal2ndTransactionReposCommonPutthroughValidator()
        {
            ...
            {
                if (checkQuoteType != QuoteType_BCGDRepos.LENH_SUA_THOATHUAN_DA_THUC_HIEN_REPOS)
                {
                    return false;
                }
                return true;
            ...
            //
            RuleForEach(x => x.SymbolFirmInfo).SetValidator(new API29SymbolFirmInfoValidator());
        }

        public class API29SymbolFirmInfoValidator : AbstractValidator<APIReposSideList>
        {
            public API29SymbolFirmInfoValidator()
            {
                //
