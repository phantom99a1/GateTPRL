...
namespace APIServer.Validation
{
    ...
    /// </summary>
    public class API22OrderConfirmReposCommonPutthroughValidator : AbstractValidator<API22OrderConfirmReposCommonPutthroughRequest>
    {
        public API22OrderConfirmReposCommonPutthroughValidator()
        {
            ...
            {
                if (checkQuoteType != QuoteType_BCGDRepos.LENH_XAC_NHAN_BCGD_REPOS)
                {
                    return false;
                }
                return true;
            ...
            //
            RuleForEach(x => x.SymbolFirmInfo).SetValidator(new API22SymbolFirmInfoValidator());
        }

        public class API22SymbolFirmInfoValidator : AbstractValidator<APIReposSideList>
        {
            public API22SymbolFirmInfoValidator()
            {
                //
