...
namespace APIServer.Validation
{
    ...
    /// </summary>
    public class API19OrderCancelFirmReposValidator : AbstractValidator<API19OrderCancelFirmReposRequest>
    {
        public API19OrderCancelFirmReposValidator()
        {
            ...
            {
                if (checkQuoteType != QuoteTypeRepos.LENH_HUY)
                {
                    return false;
                }
                return true;
