...
namespace APIServer.Validation
{
    ...
    /// </summary>
    public class API18OrderReplaceFirmReposValidator : AbstractValidator<API18OrderReplaceFirmReposRequest>
    {
        public API18OrderReplaceFirmReposValidator()
        {
            ...
            //
            RuleForEach(x => x.SymbolFirmInfo).SetValidator(new API18SymbolFirmInfoValidator());

        }
    }
    public class API18SymbolFirmInfoValidator : AbstractValidator<APIReposSideList>
    {
        public API18SymbolFirmInfoValidator()
        {
            //
