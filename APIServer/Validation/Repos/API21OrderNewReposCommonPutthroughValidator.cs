...
namespace APIServer.Validation
{
    ...
    public class API21OrderNewReposCommonPutthroughValidator : AbstractValidator<API21OrderNewReposCommonPutthroughRequest>
    {
        public API21OrderNewReposCommonPutthroughValidator()
        {
            ...
            //
            RuleForEach(x => x.SymbolFirmInfo).SetValidator(new API21SymbolFirmInfoValidator());
        }

        public class API21SymbolFirmInfoValidator : AbstractValidator<APIReposSideList>
        {
            public API21SymbolFirmInfoValidator()
            {
                //
