...
namespace APIServer.Validation
{
    ...
    /// </summary>
    public class API23OrderReplaceReposCommonPutthroughValidator : AbstractValidator<API23OrderReplaceReposCommonPutthroughRequest>
    {
        public API23OrderReplaceReposCommonPutthroughValidator()
        {
            ...
            {
                if (checkQuoteType != QuoteType_BCGDRepos.LENH_SUA_BCGD_REPOS)
                {
                    return false;
                }
                return true;
            ...
            //
            RuleForEach(x => x.SymbolFirmInfo).SetValidator(new API23SymbolFirmInfoValidator());
        }

        public class API23SymbolFirmInfoValidator : AbstractValidator<APIReposSideList>
        {
            public API23SymbolFirmInfoValidator()
            {
                //
