...
{
    public class API3ReplaceElectronicPutThroughValidator : AbstractValidator<API3ReplaceElectronicPutThroughRequest>
    {
        public API3ReplaceElectronicPutThroughValidator()
        {
