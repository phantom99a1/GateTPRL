...
{
    public class API5NewCommonPutThroughValidator : AbstractValidator<API5NewCommonPutThroughRequest>
    {
        public API5NewCommonPutThroughValidator()
        {
            ...
            {
                if (checkCrossType != ORDER_CrossType.Order_BCGDO)
                {
                    return false;
                }
                return true;
