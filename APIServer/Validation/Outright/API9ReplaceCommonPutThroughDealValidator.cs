...
namespace APIServer.Validation
{
    ...
    public class API9ReplaceCommonPutThroughDealValidator : AbstractValidator<API9ReplaceCommonPutThroughDealRequest>
    {
        public API9ReplaceCommonPutThroughDealValidator()
        {
            ...
            {
                if (checkCrossType != ORDER_CrossType.SUA_LENH_THOA_THUAN_BCGD_DA_THUC_HIEN)
                {
                    return false;
                }
                return true;
