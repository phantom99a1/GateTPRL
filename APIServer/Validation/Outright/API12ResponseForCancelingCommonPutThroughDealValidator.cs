...
namespace APIServer.Validation
{
    ...
    public class API12ResponseForCancelingCommonPutThroughDealValidator : AbstractValidator<API12ResponseForCancelingCommonPutThroughDealRequest>
    {
        public API12ResponseForCancelingCommonPutThroughDealValidator()
        {
            ...
            {
                if (checkCrossType != ORDER_CrossType.CHAP_NHAN_HUY_LENH_THOA_THUAN && checkCrossType != ORDER_CrossType.TU_CHOI_HUY_LENH_THOA_THUAN)
                {
                    return false;
                }
                return true;
