...
{
    public class API6AcceptCommonPutThroughValidator : AbstractValidator<API6AcceptCommonPutThroughRequest>
    {
        public API6AcceptCommonPutThroughValidator()
        {
            ...
            {
                if (checkCrossType != ORDER_CrossType.Accept_BCGDO)
                {
                    return false;
                }
                return true;
