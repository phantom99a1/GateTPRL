...
{
    public class MessageHelperCrossOrderCancelReplaceRequest : MessageHelper
    {
        private CrossOrderCancelReplaceRequest c_message;
        ...
        private const int TAG_OrgCrossID = 551;// shl cần sửa
        private const int TAG_OrderID = 37; //shl cần sửa
        ...
        public MessageHelperCrossOrderCancelReplaceRequest(FIXMessageBase message)
           : base(message)
        {
            c_message = (CrossOrderCancelReplaceRequest)message;
        }
        ...
        public override void BuildBody(StringBuilder sb)
        {
            ...
            if (c_message.OrdType != null && c_message.OrdType != "")
            ...
            //sb.Append(TAG_ReConfirm.ToString()).Append(Common.DELIMIT).Append(c_message.ReConfirm).Append(Common.SOH);
        ...
        public override bool ParseField(Field field)
        {
            ...
            else if (TAG_OrgCrossID == field.Tag)
            ...
            //else if (TAG_ReConfirm == field.Tag)
            //{
            //    bool _isSuccess = false;
            //    c_message.ReConfirm = Utils.Convert.ParseInt(field.Value, ref _isSuccess);
            //    if (_isSuccess == false) return false;
            //}
