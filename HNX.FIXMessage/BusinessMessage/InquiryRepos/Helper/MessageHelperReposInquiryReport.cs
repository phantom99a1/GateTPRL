...
{
    public class MessageHelperReposInquiryReport : MessageHelper
    {
        private MessageReposInquiryReport c_message;
        ...
        public MessageHelperReposInquiryReport(FIXMessageBase message)
            : base(message)
        {
            c_message = (MessageReposInquiryReport)message;
        }
        ...
        public override void BuildBody(StringBuilder sb)
        {
            ...
            sb.Append(TAG_QuoteID).Append(Common.DELIMIT).Append(c_message.QuoteID).Append(Common.SOH);
