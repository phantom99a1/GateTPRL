...
{
    public class MessageHelperReposBCGD : MessageHelper
    {
        private MessageReposBCGD c_message;
        ...
        public MessageHelperReposBCGD(FIXMessageBase message)
            : base(message)
        {
            c_message = (MessageReposBCGD)message;
        }
