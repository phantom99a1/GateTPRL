    ...
    var sweetAlert = function sweetAlert() {
        ...
        return new Promise(function (resolve, reject) {
            ...
            sweetAlert.recalculateHeight = debounce(function () {
                ...
                show(modal);
                modal.style.minHeight = modal.scrollHeight + 1 - 30 + 'px';
